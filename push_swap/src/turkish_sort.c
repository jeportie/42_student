...
/*   Updated: 2024/04/01 16:35:33 by jeportie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_calculate_push_cost(t_dclst *stack_a, t_dclst *stack_b)
{
	...
	while (current_a)
	{
		current_a->moves_a = calculate_moves_to_top(stack_a, current_a);
		current_a->moves_b = calculate_moves_to_top(stack_b, current_a->target);
