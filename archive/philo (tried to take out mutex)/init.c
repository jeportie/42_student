...
/*   Updated: 2024/09/03 13:31:33 by jeportie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	ft_init_mtdata(t_simu *simu)
{
	...
	if (
		...
		||pthread_mutex_init(&mtdata.action_mutex, NULL) != 0
		|| pthread_mutex_init(&mtdata.wait_mutex, NULL) != 0)
//		||pthread_mutex_init(&mtdata.start_mutex, NULL) != 0
