...
/*   Updated: 2024/06/14 00:15:18 by jeportie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	gc_mlx_image_register(game->wall.img_ptr, game->mlx_ptr);
...
//	gc_mlx_image_register(game->floor.img_ptr, game->mlx_ptr);
...
//	gc_mlx_image_register(game->door.img_ptr, game->mlx_ptr);
